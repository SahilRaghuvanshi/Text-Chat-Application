...
public class CallScreenActivity extends BaseActivity {
    ...
    String name,fromincome,profile;
    ImageView callingprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callingprofile = findViewById(R.id.callingvideo);
        ...
        fromincome =getIntent().getStringExtra("intocallscreen");
        name =getIntent().getStringExtra("name");
        if(fromincome!=null) {
            mCallerName.setText(fromincome);
        }
        else{
            mCallerName.setText(name);
            Picasso.get().load(profilepic).placeholder(R.drawable.someone).into(callingprofile);}
    ...
    private class SinchCallListener implements VideoCallListener {
        ...
        public void onCallEstablished(Call call) {
            ...
            mCallStart = System.currentTimeMillis();
            callingprofile.setVisibility(View.INVISIBLE);
