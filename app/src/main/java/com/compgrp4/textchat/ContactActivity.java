...
import com.compgrp4.textchat.Adapters.ContactAdapter;
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        ContactAdapter contactAdapter = new ContactAdapter(ContactActivity.this,mUsers,false,encryption,ContactActivity.this);
